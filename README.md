...
- <a href="https://github.com/Lancelot-SO/hello-rails-back-end">Rails Link</a>
...
```sh
 git clone https://github.com/Lancelot-SO/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/Lancelot-SO/hello-react-front-end/issues).
